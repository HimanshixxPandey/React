      ...
      <div>
        ...
        <div className="main">
          <div className="row">
           ...
           <ul class="list-group favoutrites-genres">
            {
          ...
          <div className="col-lg-9 favourites-table">
          <div className="row">
            ...
            <input type="text" className="input-group-text col" placeholder="Search" value={this.state.currText} onChange={(e)=>this.setState({currText:e.target.value})}/>
            <input type="number" className='input-group-text col' placeholder='RowCount' value={this.state.limit} onChange={(e)=>this.setState({limit:e.target.value})}/>
          </div>
          <div className="row">
          <table class="table">
  <thead>
